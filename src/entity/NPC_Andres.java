...
public class NPC_Andres extends Entity {
    ...
    public void getImage() {
        up1 = setup("/res/npc/andres/up1", gp.tileSize, gp.tileSize);
        up2 = setup("/res/npc/andres/up2", gp.tileSize, gp.tileSize);
        down1 = setup("/res/npc/andres/down1", gp.tileSize, gp.tileSize);
        down2 = setup("/res/npc/andres/down2", gp.tileSize, gp.tileSize);
        left1 = setup("/res/npc/andres/left1", gp.tileSize, gp.tileSize);
        left2 = setup("/res/npc/andres/left2", gp.tileSize, gp.tileSize);
        right1 = setup("/res/npc/andres/right1", gp.tileSize, gp.tileSize);
        right2 = setup("/res/npc/andres/right2", gp.tileSize, gp.tileSize);
    }
